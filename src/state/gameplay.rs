//! Gameplay module shim to use the refactored implementation.

#[path = "gameplay/mod.rs"]
mod gameplay_impl;

pub use gameplay_impl::*;
...
impl GameplayState {
    pub fn new(data: &GameData) -> Self {
        ...
        Self {
            ...
            wave_manager: WaveManager::new(WaveTuning {
                spawn_interval: data.constants.wave_spawn_interval,
                commander_aura_radius: data.constants.commander_aura_radius,
                commander_aura_speed_mult: data.constants.commander_aura_speed_mult,
                enemy_tuning: EnemyTuning {
                    scout_dodge_chance: data.constants.scout_dodge_chance,
                    scout_dodge_duration: data.constants.scout_dodge_duration,
                    hit_flash_duration: data.constants.enemy_hit_flash_duration,
                    saboteur_skip_chance: data.constants.saboteur_skip_chance,
                    slow_multiplier: data.constants.slow_multiplier,
                },
                wave_budget_base: data.constants.wave_budget_base,
                wave_budget_per_wave: data.constants.wave_budget_per_wave,
                wave_commander_every: data.constants.wave_commander_every,
                threat_budget_divisor: data.constants.threat_budget_divisor,
                threat_health_mult_per_awareness: data.constants.threat_health_mult_per_awareness,
            }),
            threat,
            population: Population::new(&data.constants),
            resources: Resources {
                power: data.constants.starting_power,
                scrap: data.constants.starting_scrap,
                data_cores: 0,
            },
            current_wave: 0,
            paused: false,
            ...
            wave_timer: data.constants.ui_wave_start_delay,
            wave_interval: data.constants.wave_interval_seconds,
            between_waves: true,
            ...
            base_health_scale_per_wave: data.constants.health_scale_per_wave,
            base_food_per_wave: data.constants.food_per_wave,
    ...
    fn apply_save(&mut self, data: &GameData, save: SaveData) {
        ...
        self.wave_manager = WaveManager::new(WaveTuning {
            spawn_interval: self.constants.wave_spawn_interval,
            commander_aura_radius: self.constants.commander_aura_radius,
            commander_aura_speed_mult: self.constants.commander_aura_speed_mult,
            enemy_tuning: EnemyTuning {
                scout_dodge_chance: self.constants.scout_dodge_chance,
                scout_dodge_duration: self.constants.scout_dodge_duration,
                hit_flash_duration: self.constants.enemy_hit_flash_duration,
                saboteur_skip_chance: self.constants.saboteur_skip_chance,
                slow_multiplier: self.constants.slow_multiplier,
            },
            wave_budget_base: self.constants.wave_budget_base,
            wave_budget_per_wave: self.constants.wave_budget_per_wave,
            wave_commander_every: self.constants.wave_commander_every,
            threat_budget_divisor: self.constants.threat_budget_divisor,
            threat_health_mult_per_awareness: self.constants.threat_health_mult_per_awareness,
        });
