...
pub const TILE_NAMES: [&str; 64] = [
    "floor_plate_intact_a", "floor_plate_intact_b", "floor_plate_intact_c", "floor_plate_cracked_a",
    "floor_plate_cracked_b", "floor_plate_rusted_a", "floor_plate_rusted_b", "floor_plate_oil_stain",
    "floor_plate_shallow_water", "floor_grate", "floor_hazard_stripe", "floor_collapsed_void",
    "wall_isolated", "wall_end_n", "wall_end_e", "wall_end_s", "wall_end_w", "wall_straight_ns",
    "wall_straight_ew", "wall_corner_ne", "wall_corner_es", "wall_corner_sw", "wall_corner_wn",
    "wall_t_nes", "wall_t_esw", "wall_t_swn", "wall_t_wne", "wall_cross",
    "route_straight_ns", "route_straight_ew", "route_corner_ne", "route_corner_es", "route_corner_sw",
    "route_corner_wn", "route_t_nes", "route_t_esw", "route_t_swn", "route_t_wne", "route_cross", "route_broken",
    "decal_rubble_light", "decal_rubble_medium", "decal_rubble_heavy", "decal_broken_pipes", "decal_loose_cables",
    "decal_scrap_pile", "decal_water_leak", "decal_scorch_marks", "decal_moss", "decal_collapsed_beam",
    "decal_repair_scaffold", "decal_power_cable", "section_scrap_processing", "section_water_filtration",
    "section_power_spine", "section_assembly_hall", "section_logistics_hub", "section_hydroponics",
    "section_robotics_bay", "section_research_core", "section_ai_vault", "section_factory_heart",
    "breach_sealed_floor", "breach_open_floor",
];
...
pub const SECTION_TILES: [&str; 10] = [
    "section_scrap_processing", "section_water_filtration", "section_power_spine",
    "section_assembly_hall", "section_logistics_hub", "section_hydroponics", "section_robotics_bay",
    "section_research_core", "section_ai_vault", "section_factory_heart",
];
...
pub fn tile_rect(name: &str) -> Rect {
    let cell = TILE_NAMES.iter().position(|candidate| *candidate == name).unwrap_or(0);
    Rect::new((cell % 8) as f32 * 64.0, (cell / 8) as f32 * 64.0, 64.0, 64.0)
}
